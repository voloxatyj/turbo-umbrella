			...
			<form className="firstForm mt-5" onSubmit={handleSubmit}>
				<div className="firstForm-row">
					...
					<div className="col-sm-8 col-md-10 col-lg-12 mb-3">
						...
						<select
							className={`form-control ${!user.country_id ? ""	: errors.country_id	? "htmlForm-control is-invalid"	: "htmlForm-control is-valid"}`}
							id="country"
							onChange={(e) => {
					...
					<div className="col-xs-4 col-sm-8 col-md-10 col-lg-12 mb-3">
						...
						<InputMask
							...
							className={!user.phone ? "form-control"	: errors.phone ? "form-control is-invalid" : "form-control is-valid"}
						></InputMask>
						<Notifications
							positive="Looks good!"
					...
					<div className="col-xs-4 col-sm-8 col-md-10 col-lg-12 mb-3">
						...
						<DatePicker
							id="birthdate"
							className={todayDate	? "form-control"	: errors.birthdate	? "form-control is-invalid"	: "form-control is-valid"}
						...
						<div
							...
							style={{display: todayDate	? "none"	: errors.birthdate	? "none"	: "block"}}
						>
							Looks good!
						</div>
						<div
