...
export const FormPage: React.FC = (): JSX.Element => {
  ...
  return (
    <>
      <Header />
      {(tab_form.startsWith('first') || tab_form.startsWith('second')) && (
        <Map />
      )}
      <div
        className='main-container'
        style={{
          height: tab_form.startsWith('third') ? '90vh' : '',
      ...
      >
        <div
          ...
          style={{
            width: tab_form.startsWith('third') ? '90%' : '40%',
            display: tab_form.startsWith('third') ? 'grid' : '',
            gridTemplateRows: tab_form.startsWith('third')
              ? '10em 15em 1fr 10em'
              : 'none',
          }}
        >
          {!tab_form.startsWith('second') && (
            <div
              ...
              style={{
                display: tab_form.startsWith('third') ? 'grid' : 'inherit',
